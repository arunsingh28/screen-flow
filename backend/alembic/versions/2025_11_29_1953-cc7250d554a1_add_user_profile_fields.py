...
def downgrade() -> None:
    ...
    sa.Column('activity_type', postgresql.ENUM('JOB_CREATED', 'CV_UPLOADED', 'CV_PROCESSED', 'CV_FAILED', 'JOB_CLOSED', 'JOB_REOPENED', name='activitytype'), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['job_id'], ['cv_batches.id'], name='activities_job_id_fkey'),
    ...
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('type', postgresql.ENUM('PURCHASE', 'USAGE', name='credit_txn_type_final'), autoincrement=False, nullable=False),
